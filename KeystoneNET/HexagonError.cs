...
namespace KeystoneNET
{
  ...
  {
    KS_ERR_ASM_HEXAGON_INVALIDOPERAND = 512, // 0x0200
    KS_ERR_ASM_HEXAGON_MISSINGFEATURE = 513, // 0x0201
    KS_ERR_ASM_HEXAGON_MNEMONICFAIL = 514, // 0x0202
  }
}
